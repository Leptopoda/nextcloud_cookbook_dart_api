...
import 'package:nc_cookbook_api/src/serializers.dart';
import 'package:nc_cookbook_api/src/auth/api_key_auth.dart';
import 'package:nc_cookbook_api/src/auth/basic_auth.dart';
import 'package:nc_cookbook_api/src/auth/bearer_auth.dart';
import 'package:nc_cookbook_api/src/auth/oauth.dart';
import 'package:nc_cookbook_api/src/api/categories_api.dart';
import 'package:nc_cookbook_api/src/api/misc_api.dart';
import 'package:nc_cookbook_api/src/api/recipes_api.dart';
import 'package:nc_cookbook_api/src/api/tags_api.dart';

class NcCookbookApi {
  static const String basePath = r'http://localhost:8000/apps/cookbook';
